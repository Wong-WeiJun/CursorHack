...
const LayoutCursorDemoRoute = LayoutCursorDemoRouteImport.update({
  id: '/cursor-demo',
  path: '/cursor-demo',
  getParentRoute: () => LayoutRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_layout/cursor-demo': {
      id: '/_layout/cursor-demo'
      path: '/cursor-demo'
      fullPath: '/cursor-demo'
      preLoaderRoute: typeof LayoutCursorDemoRouteImport
      parentRoute: typeof LayoutRoute
    }
    '/_layout/admin': {
      id: '/_layout/admin'
